...
var ArrayInputField = React.createClass({
	...
	render : function () {
		return(
			<input type="text" placeholder="Enter your array" ref="arrayField" id="userInput" className="textInput" autoComplete="off" onKeyPress={this.handleKeyPress} onKeyUp={this.handleKeyUp} />
		)
	}
});
